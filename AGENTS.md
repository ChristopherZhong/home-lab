...
- `.agents/prompts/`: Shared reusable prompt templates for repository workflows.
- `.agents/skills/`: Shared reusable skills in an open-standard style location.
- `.github/copilot-instructions.md`: Thin GitHub Copilot compatibility instructions.
- `CLAUDE.md`: Thin Claude compatibility wrapper that imports `AGENTS.md`.
...
- Keep `CLAUDE.md` and `.github/copilot-instructions.md` thin so they do not become competing sources of truth.
