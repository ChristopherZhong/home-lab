...
Your job is to coordinate the `review-manifests` workflow.

Primary implementation path:

- Use the skill at `.agents/skills/review-manifests/SKILL.md` as the procedural source of truth.
...
- Follow the workflow defined in the `review-manifests` skill rather than duplicating it here.
...
- Running the `review-manifests` skill against the right files
